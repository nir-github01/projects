...
function UpdateAdoptForm(props) {
    ...
    const handleSubmit = async(e) => {
        ...
        e.preventDefault();
        // const postresponse = await fetch("http://localhost:4000/adoptpets/update/:id", {
        //     method:'PATCH',
        ...
        let recievedData = await fetch("http://localhost:4000/adoptpets/update/:id", {
                method:"PUT",
                body:JSON.stringify(updateform),
                    headers:{
        ...
        let updateadoptdata = recievedData.json();
            setUpdateForm(updateadoptdata);
            console.log(updateform);
            console.log("adoptdata"+""+ JSON.stringify(updateadoptdata));   
    }
        ...
        <>
            ...
            <Button onClick={adopterlistPage} variant='success'>Adopter List</Button>
                ...
                <Form.Label htmlFor="inputGender">Pet type</Form.Label>
                        <Form.Select name='PetType' aria-label="select-profession" value={updateform.PetType} onChange={handlesInputs} /**</div>onChange={handlePets}  value={pettype}*/ >
...
export default UpdateAdoptForm;
